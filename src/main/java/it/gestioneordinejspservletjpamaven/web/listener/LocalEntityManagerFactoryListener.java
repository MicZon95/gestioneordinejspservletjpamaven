package it.gestioneordinejspservletjpamaven.web.listener;
...
public class LocalEntityManagerFactoryListener implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent sce) {
		try {
			entityManagerFactory = Persistence.createEntityManagerFactory("gestioneordinejspservletjpamaven_unit");
		} catch (Throwable ex) {
